...
nohup python Trainer.py --do_eval --do_predict --evaluate_during_training \
    --data_dir="data/dataset/NER/resume" \
    --output_dir="data/result/NER/resume/upload" \
    ...
    --max_word_num=5 \
    --label_file="data/dataset/NER/resume/labels.txt" \
    --word_embedding="data/embedding/word_embedding.txt" \
    --saved_embedding_dir="data/dataset/NER/resume" \
    ...
    --warmup_steps=190 \
    --save_steps=600 \
    --logging_steps=300 > resLogs/resume-2.log 2>&1 &
